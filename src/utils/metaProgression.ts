...
export const META_UPGRADES_CONFIG: MetaUpgrade[] = [
  {
    ...
    currentLevel: 0,
    costPerLevel: [30, 95, 240, 520, 1050],
    statKey: 'maxHp',
    bonusPerLevel: 3,
    unit: 'HP',
  },
  {
    ...
    maxLevel: 5, // Strict hard cap
    currentLevel: 0,
    costPerLevel: [40, 130, 320, 690, 1400],
    statKey: 'armor',
    bonusPerLevel: 0.5,
    unit: 'Броня',
  },
  {
    ...
    maxLevel: 5, // Strict hard cap
    currentLevel: 0,
    costPerLevel: [35, 115, 290, 620, 1250],
    statKey: 'psiPower',
    bonusPerLevel: 2,
    unit: '% Силы',
  },
  {
    ...
    maxLevel: 5, // Strict hard cap
    currentLevel: 0,
    costPerLevel: [35, 120, 300, 640, 1300],
    statKey: 'attackSpeed',
    bonusPerLevel: 2,
    unit: '% Скор.',
  },
  {
    ...
    maxLevel: 5, // Strict hard cap
    currentLevel: 0,
    costPerLevel: [25, 85, 210, 450, 900],
    statKey: 'startingDna',
    bonusPerLevel: 10,
    unit: 'ДНК',
  },
  ...
  /*
   * The nine below widen the catalogue.
   *
   * With five entries there was one sensible purchase order and the tree was done in a
   * couple of runs. These give the research budget somewhere else to go - reach, harvest,
   * mobility, recovery, resonance - so two players' permanent progression can differ, and
   * so a run that ends badly still advances something the player chose.
   */
  {
    id: 'meta_vector_reach',
    name: 'Vector Elongation Therapy',
    russianName: 'Терапия удлинения векторов',
    description: 'Permanently extends the reach of the vectors (+2% per tier).',
    russianDescription: 'Постоянно увеличивает радиус векторов (+2% за уровень). Отодвигает и стрелков SAT, которые держат дистанцию по вашему радиусу.',
    icon: 'Maximize2',
    maxLevel: 5,
    currentLevel: 0,
    costPerLevel: [45, 150, 380, 810, 1650],
    statKey: 'vectorReach',
    bonusPerLevel: 2,
    unit: '% Радиуса',
  },
  {
    id: 'meta_harvest',
    name: 'Genetic Sample Refinement',
    russianName: 'Очистка генетических образцов',
    description: 'Extracts more usable DNA from every sample (+6% per tier).',
    russianDescription: 'Извлекает больше пригодной ДНК из каждого образца (+6% за уровень).',
    icon: 'Dna',
    maxLevel: 5,
    currentLevel: 0,
    costPerLevel: [40, 135, 340, 730, 1480],
    statKey: 'dnaHarvest',
    bonusPerLevel: 6,
    unit: '% ДНК',
  },
  {
    ...
    russianName: 'Ускоренный метаболизм',
    description: 'Permanently raises movement speed (+5 px/s per tier).',
    russianDescription: 'Постоянно повышает скорость передвижения (+5 к скорости за уровень).',
    icon: 'Wind',
    maxLevel: 5,
    currentLevel: 0,
    costPerLevel: [50, 165, 410, 880, 1780],
    statKey: 'moveSpeed',
    bonusPerLevel: 5,
    unit: 'Скорости',
  },
  {
    id: 'meta_regen',
    name: 'Diclonius Tissue Grafts',
    russianName: 'Трансплантация тканей диклониуса',
    description: 'Wounds close on their own (+1 HP per 5s per tier).',
    russianDescription: 'Раны затягиваются сами (+1 ОЗ каждые 5 секунд за уровень).',
    icon: 'HeartPulse',
    maxLevel: 5,
    currentLevel: 0,
    costPerLevel: [60, 195, 490, 1050, 2100],
    statKey: 'hpRegen',
    bonusPerLevel: 1,
    unit: 'Регена',
  },
  {
    id: 'meta_pickup',
    name: 'Field Collection Drones',
    russianName: 'Полевые дроны сбора',
    description: 'Widens the radius at which samples are drawn in (+18px per tier).',
    russianDescription: 'Расширяет радиус притяжения образцов (+18px за уровень).',
    icon: 'Magnet',
    maxLevel: 5,
    currentLevel: 0,
    costPerLevel: [30, 100, 250, 540, 1100],
    statKey: 'pickupRange',
    bonusPerLevel: 18,
    unit: 'px',
  },
  {
    id: 'meta_crit',
    name: 'Vital Point Mapping',
    russianName: 'Картирование болевых точек',
    description: 'Improves the odds of a lethal strike (+2% crit chance per tier).',
    russianDescription: 'Повышает шанс смертельного удара (+2% шанса крита за уровень).',
    icon: 'Crosshair',
    maxLevel: 5,
    currentLevel: 0,
    costPerLevel: [55, 180, 450, 960, 1950],
    statKey: 'critChance',
    bonusPerLevel: 2,
    unit: '% Крита',
  },
  {
    ...
    russianName: 'Резонансный камертон',
    description: 'Raises the resting vibration frequency of the vectors (+45 Hz per tier).',
    russianDescription: 'Поднимает частоту покоя векторов (+45 Гц за уровень). Излишек сверх потолка идёт в скорость разгона до режущих и детонирующих диапазонов.',
    icon: 'AudioWaveform',
    maxLevel: 5,
    currentLevel: 0,
    costPerLevel: [50, 170, 420, 900, 1820],
    statKey: 'vibrationBase',
    bonusPerLevel: 45,
    unit: 'Гц',
  },
  {
    id: 'meta_luck',
    name: 'Requisition Clearance',
    russianName: 'Допуск к спецзаказам',
    description: 'Better shop and drop rarity (+3% luck per tier).',
    russianDescription: 'Лучшая редкость в магазине и в дропе (+3% удачи за уровень).',
    icon: 'Sparkles',
    maxLevel: 5,
    currentLevel: 0,
    costPerLevel: [65, 210, 530, 1140, 2300],
    statKey: 'luck',
    bonusPerLevel: 3,
    unit: '% Удачи',
  },
  {
    id: 'meta_dodge',
    name: 'Precognitive Reflex Training',
    russianName: 'Тренировка упреждающих рефлексов',
    description: 'Reads the shot before it is fired (+1.5% dodge per tier).',
    russianDescription: 'Читает выстрел до того, как он прозвучал (+1.5% уклонения за уровень).',
    icon: 'Eye',
    maxLevel: 5,
    currentLevel: 0,
    costPerLevel: [70, 230, 580, 1240, 2500],
    statKey: 'dodge',
    bonusPerLevel: 1.5,
    unit: '% Уклон.',
  },
